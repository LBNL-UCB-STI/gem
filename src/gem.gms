...
(vehiclePerYearCosts / 365 + vehicleCapitalCost * (1 / (vehicleLifetime(b,rmob)*365) + dailyDiscountRate)) + batteryRatio(rmob) * batteryCapacity(b) * batteryCapitalCost * (1 / (vehicleLifetime(b,rmob)*365) + dailyDiscountRate)) =e= 0;
